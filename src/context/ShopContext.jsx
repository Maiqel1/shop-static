...
export const ShopContextProvider = (props) => {
    ...
    const getAPIData = async (page) => {
        try {
            const response = await fetch(`https://api.timbu.cloud/products/?organization_id=${process.env.REACT_APP_ORGANIZATION_ID}&reverse_sort=false&page=${page}&size=${productsPerPage}&Appid=${process.env.REACT_APP_APP_ID}&Apikey=${process.env.REACT_APP_API_KEY}`);
